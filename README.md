...
| 字段名                                                       | 字段类型                      | 字段说明                          |
| ------------------------------------------------------------ | ----------------------------- | --------------------------------- |
| status &nbsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | 字符串                        | 接口正确响应时为Ok，出错为Fail    |
...
| 字段名                                                       | 字段类型                                                     | 字段说明           |
| :----------------------------------------------------------- | ------------------------------------------------------------ | ------------------ |
| id&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp; | 整型&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp; | placement 广告位ID |
| ads                                                          | ad对象数组                                                   |                    |
...
| 字段名                                                       | 字段类型                                                     | 字段说明        |
| ------------------------------------------------------------ | ------------------------------------------------------------ | --------------- |
| id&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | 整数                                                         | 广告ID          |
...
| 有效值                                                       | 描述                                  |
| ------------------------------------------------------------ | ------------------------------------- |
| 0&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | Unknown                               |
| 1                                                            | Ethernet                              |
| 2                                                            | WiFi                                  |
